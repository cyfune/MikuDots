...
**Dependencies**
```
sudo pacman -S hyprland hyprpaper kitty waybar fuzzel swaync pipewire pipewire-pulse wireplumber blueman nwg-look ttf-jetbrains-mono ttf-jetbrains-mono-nerd
```
